...
app.listen(PORT, () => {
  ...
  console.log(`Register: POST http://0.0.0.0:${PORT}/api/auth/register`);
  console.log(`Login: POST http://0.0.0.0:${PORT}/api/auth/login`);
  console.log(`Protected routes (e.g., Get All Users): GET http://0.0.0.0:${PORT}/api/users (requires Bearer token)`);
});
