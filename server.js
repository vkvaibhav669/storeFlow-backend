...
app.listen(PORT, () => {
 ...
 // console.log(`Access API at http://:${PORT}`);
  //console.log(`Register: POST http://:${PORT}/api/auth/register`);
  //console.log(`Login: POST http://:${PORT}/api/auth/login`);
  //console.log(`Protected routes (e.g., Get All Users): GET http://:${PORT}/api/users (requires Bearer token)`);
});
